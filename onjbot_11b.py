...
import discord
import random
import onenight_jinro_11b as onj
import time
from time import sleep

accesstoken = "NTA4NjIxMTk3MTAyMjg0ODIw.DsB6Ng.OvftWauFaczzIqN00z7ubZ_Y2sc" # ここにアクセストークン
channelid = 566953245667229696 # メインチャンネルのID
